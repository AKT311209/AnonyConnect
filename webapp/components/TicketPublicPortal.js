                      ...
                      tickets.map(ticket => (
                        <tr key={ticket.ticket_id} style={{ borderWidth: '1px' }}>
                          ...
                          <td className="text-center" style={{ textAlign: 'center' }}>
                            <Link href={`/ticket/${ticket.ticket_id}`} target="_blank" rel="noopener noreferrer" className="btn btn-success border rounded border-1 mt-1" style={{ marginLeft: '5px', borderColor: 'var(--bs-primary)', background: 'var(--bs-primary)' }}>
