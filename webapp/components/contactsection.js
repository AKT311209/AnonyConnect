...
const ContactSection = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    // Ensure the function returns after handling the response
  }
            ...
            <div className='d-flex flex-column align-items-start h-100 mt-0 pt-0'>
              ...
              <div className='d-flex align-items-center p-3 mb-0 pb-0'>
                ...
                <div className='px-2'>
                  ...
                  <p className='mb-0'><a className='link-dark' href='https://about.khoi.io.vn' target='_blank' rel='noreferrer'><strong>https://about.khoi.io.vn</strong></a></p>
                </div>
              </div>
            </div>
          </div>
          <div className='col-md-6 col-lg-5 col-xl-4'>
            <div>
              <form className='p-3 p-xl-4 pe-0 me-0 ps-0 ms-0 mb-3' method='post' onSubmit={handleSubmit}>
                ...
                <div className='mb-3'><textarea className='border rounded form-control mb-3' id='message-2' name='message' rows='6' placeholder='Message (required)' required /></div>
